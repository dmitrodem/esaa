...
def init_buffer():
    ...
    # file_name = "new.j4"
    # file_name = "new.m73"
    file_name = r"C:\esaa\M74\i464gl08\script\M74_typeI.m74"
    # file_name = "test.m75"
    # file_name = "test.mt80"
...
f_res = open(r"C:\esaa\M74\i464gl08\script\m74_map.txt", 'wb')
f_res.write(res_str)
f_res.close()